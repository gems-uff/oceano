 ...
 * @author dheraclio
 */
public class TestNOP extends BaseMetricTest {

    public TestNOP() {
        super(MetricEnumeration.NOP.getName(), Language.JAVA,NumberOfPolymorphicMethodsExtractorJava.class);
    ...
    public void beforeClass() {
        super.beforeClass();
        addTestScenario(new TestScenario(testConstantsJava.getRevisionTestMavenProject(), 3.0));
    }
}
