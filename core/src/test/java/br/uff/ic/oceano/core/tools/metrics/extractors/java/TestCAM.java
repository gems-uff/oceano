 ...
 * @author dheraclio
 */
public class TestCAM extends BaseMetricTest {

    public TestCAM() {
        super(MetricEnumeration.CAM.getName(), Language.JAVA,CohesionAmongMethodsInClassExtractorJava.class);
    ...
    public void beforeClass() {
        super.beforeClass();
        addTestScenario(new TestScenario(testConstantsJava.getRevisionTestMavenProject(), JavaProjectsHelper.CARRO_CLASS, 0.13));
