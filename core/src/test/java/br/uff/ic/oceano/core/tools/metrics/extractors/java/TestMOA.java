 ...
 * @author dheraclio
 */
public class TestMOA extends BaseMetricTest {

    public TestMOA() {
        super(MetricEnumeration.MOA.getName(), Language.JAVA,MeasureOfAggregationExtractorJava.class);
    }
    ...
    public void beforeClass() {
        super.beforeClass();
        addTestScenario(new TestScenario(testConstantsJava.getRevisionTestMavenProject(), 5.0));
    }
}
