 ...
 * @author dheraclio
 */
public class TestNOH extends BaseMetricTest {

    public TestNOH() {
        super(MetricEnumeration.NOH.getName(), Language.JAVA,NumberOfHierarchiesExtractorJava.class);
    }
    ...
    public void beforeClass() {
        super.beforeClass();
        addTestScenario(new TestScenario(testConstantsJava.getRevisionTestMavenProject(), JavaProjectsHelper.PACKAGE_TESTMAVENPROJECT, 4.0));
