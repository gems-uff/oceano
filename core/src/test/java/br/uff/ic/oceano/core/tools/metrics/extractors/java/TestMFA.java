 ...
 * @author dheraclio
 */
public class TestMFA extends BaseMetricTest {

    public TestMFA() {
        super(MetricEnumeration.MFA.getName(), Language.JAVA,MeasureOfFunctionalAbstractionExtractorJava.class);
    }
    ...
    public void beforeClass() {
        ...
        addTestScenario(new TestScenario(testConstantsJava.getRevisionMavenprojectMFA(), 0.5));
    }
