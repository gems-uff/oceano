 ...
 * @author wallace
 */
public class NumberOfStaticAttributesExtractorJava extends AbstractMetricExtractor {

    public NumberOfStaticAttributesExtractorJava() {
    }
